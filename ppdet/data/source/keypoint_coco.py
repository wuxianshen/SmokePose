...
#from ppdet.third_parties import pycocotools
#from ppdet.third_parties.pycocotools.coco import COCO
...
class KeypointBottomUpBaseDataset(DetDataset):
    ...
    def __getitem__(self, idx):
        ...
        assert isinstance(records['image'], np.ndarray), \
            f'Invalid image file {records["image_file"]}'
