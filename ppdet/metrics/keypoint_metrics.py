...
from ppdet.smoke_kp import SKPCOCOEval
...
class KeyPointTopDownCOCOEval(object):
    ...
    def update(self, inputs, outputs):
        ...
        self.results['all_preds'][self.idx:self.idx + num_images, :,
                                  0:3] = kpts[:, :, 0:3]
    ...
    def accumulate(self):
        ...
        if _C.DATASET.DATA_TYPE == 'COCO':
            coco_eval = COCOeval(self.coco, coco_dt, 'keypoints')
        elif _C.DATASET.DATA_TYPE == 'SKP':
            coco_eval = SKPCOCOEval(self.coco, coco_dt, 'keypoints')
        else:
            assert False, \
                f'Invalid DATA_TYPE {_C.DATASET.DATA_TYPE}'
