...
from ppdet.smoke_kp.skp_data.skp_metrics import SKPCOCOEval


__all__ = [
    'skp_get_infer_results',
    'skp_cocoapi_eval'
]


def skp_get_infer_results(outs, catid, bias=0):
    """
...
def skp_cocoapi_eval(jsonfile,
    ...
    if style == 'proposal':
        ...
        coco_eval = SKPCOCOEval(coco_gt, coco_dt, style)
    coco_eval.evaluate()
